				...
				<form action="">
					...
					<div className="mt-8">
						...
						<div className="flex flex-cols flex-wrap mt-4">
							<button
								type="button"
								className="py-2.5 w-full text-center rounded-lg shadow-lg text-teal-700 hover:text-teal-800 hover:shadow-xl"
							>
								Google
							</button>
							<button
								type="button"
								className="py-2.5 w-full mt-3 text-center rounded-lg shadow-lg text-teal-700 hover:text-teal-800 hover:shadow-xl"
							>
								Facebook
							</button>
						</div>
